...
namespace XLua
{
    ...
    {
        public void __RegisterUnityEngineUIScrollRectScrollRectEvent(RealStatePtr L) 
        {
		    ...
		    Utils.BeginClassRegister(type, L, __CreateInstanceUnityEngineUIScrollRectScrollRectEvent, 1, 0, 0);
